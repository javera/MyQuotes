...
/**
 * <p>
 * A custom <code>TextView</code> that displays text using a custom <code>Typeface</code> that can be set in your XML
 * layout.
 * </p>
 * <p>
 * To use the custom view attributes in your layout, you'll need to first declare the custom namespace using the xmlns
 * directive:
 * </p>
 * <code><pre>
 ...
 * <p>
 * You can then set the typeface by providing the prefix of the desired typeface file with the
 * <code>simple:typeface</code> attribute.
 * </p>
 * <p>
 * Your typeface resources should be saved to the <code>assets/fonts</code> directory of your project.
 * </p>
 * <p>
 * Files should include the suffix <code>-Family.otf</code> (e.g. <code>GothamMediumTabular-Family.otf</code>).
 * </p>
 * 
